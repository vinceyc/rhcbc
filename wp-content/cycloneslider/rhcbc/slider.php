...
?>
<div tabindex="0" class="cycloneslider cycloneslider-template-giantspoon cycloneslider-width-<?php echo esc_attr( $slider_settings['width_management'] ); ?>"
        ...
        <?php foreach($slides as $slide): ?>
            ...
            <?php elseif ( 'vimeo' == $slide['type'] ) : ?>
             ...
             <?php elseif ( 'video' == $slide['type'] ) : ?>
                <div class="cycloneslider-slide cycloneslider-slide-video" <?php echo $slide['slide_data_attributes']; ?> style="padding-bottom:0%">
                    <?php echo $slide['video_embed_code']; ?>
                </div>
    ...
    <div class="slider-area-prev">
    </div>
    <div class="slider-area-next">
    </div>
    <?php endif; ?>
</div>