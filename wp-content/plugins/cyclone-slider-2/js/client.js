...
(function() {
    ...
    slides_selector += ',.cycloneslider-template-giantspoon .cycloneslider-slides';
    ...
    jQuery(document).on('cycle-before', slides_selector, function( event, optionHash, outgoingSlideEl, incomingSlideEl, forwardFlag ) {
        var slide = jQuery( outgoingSlideEl ), /* Current slide */
            nextSlide = jQuery( incomingSlideEl ), /* Upcoming slide */
            curHeight = 0,
            nextHeight = 0;
        ...
        if(slide.hasClass('cycloneslider-slide-video')) {
            document.getElementById(jQuery(slide).children('video').attr('id')).pause();
        } //Pause video before going to next slide


        // if(nextSlide.hasClass('cycloneslider-slide-video')) {
        //     document.getElementById(jQuery(nextSlide).children('video').attr('id')).play();
        // }
