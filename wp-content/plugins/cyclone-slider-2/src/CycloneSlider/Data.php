    ...
    public function add_slider_slides( $slider_id, $slides ){
        ...
        if( is_array($slides) ){
            ...
            foreach($slides as $slide){
                ...
                $slides_to_save[$i]['video_id'] = (int) ($slide['video_id']);
                $slides_to_save[$i]['video_title'] = wp_kses_post($slide['video_title']);
                $slides_to_save[$i]['poster_id'] = (int) ($slide['poster_id']);
                $slides_to_save[$i]['video_thumb'] = esc_url_raw($slide['video_thumb']);
                $slides_to_save[$i]['video_url'] = esc_url_raw($slide['video_url']);
                $slides_to_save[$i]['poster_url'] = esc_url_raw($slide['poster_url']);
